...
def countNumbersUpTo(stop_char):
    ...
    porordem_crescente = sorted(list_numbers, reverse=True)
    # sorted permite sortear os valores permitindo escolher a lista sobre a qual atuar e o filtro a aplicar
    
    
    print(porordem_crescente)
